...
<html>
  ...
  <%--<link href="/static/refre/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />--%>
	  ...
	  <script src="/static/refre/predeter/dengji.js"></script>
								  ...
								  <div class="col-md-12 clearfix">
									  ...
									  <div class="checkout-total-block">
										  <ul>
											  <li>
												  <em>房间费</em>
												  <strong class="price" id="roomCharge">${room.standardPriceDay}</strong>
											  </li>
											  <li>
												  <em>押金</em>
												  <strong class="price" id="deposit">${p.deposit}</strong>
											  </li>
											  <li>
												  <em>商品费</em>
											  ...
											  <li class="checkout-total-price">
												  <em>总额</em>
												  <strong class="price" id="totalAmount">${room.standardPriceDay}</strong>
											  </li>
										  </ul>
									  </div>
