...
<!--   <link rel="stylesheet" href="/static/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <!-- 右键功能  start  .css -->
  <%-- <link rel="stylesheet" href="/static/css/youjian/default.css" type="text/css"></link>
  <link rel="stylesheet" href="/static/css/youjian/font-awesome.css" type="text/css"></link>
  <link rel="stylesheet" href="/static/css/youjian/github-light.css" type="text/css"></link>
  <link rel="stylesheet" href="/static/css/youjian/highlight-8.6.default.min.css" type="text/css"></link>
  <link rel="stylesheet" href="/static/css/youjian/normalize.css" type="text/css"></link>
  <link rel="stylesheet" href="/static/css/youjian/styles.css" type="text/css"></link>
  <link rel="stylesheet" href="/static/css/youjian/toastr.css" type="text/css"></link> --%>
  <!-- 右键功能  end  .css -->
  
  <!-- 右键功能  start  .js -->
  <%-- <script type="text/javascript" src="/static/js/youjian/BootstrapMenu.min.js"></script>
  <script type="text/javascript" src="/static/js/youjian/highlight-8.6.default.min.js"></script>
  <script type="text/javascript" src="/static/js/youjian/scale.fix.js"></script>
  <script type="text/javascript" src="/static/js/youjian/toastr.js"></script> --%>
  <!-- 右键功能  end  .js -->
